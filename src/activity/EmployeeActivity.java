...
public class EmployeeActivity extends JFrame implements ActionListener {
	...
	private JButton buttonLogout, buttonProfile, buttonViewProduct,buttonViewProductSales,buttonViewProductStore;
	...
	public EmployeeActivity(String userId) {
		...
		buttonViewProductSales = new JButton("View Sales History");
		//buttonViewProduct.setBounds(60, 160, 200, 30);
		buttonViewProductSales.setFont(Theme.FONT_BUTTON);
		buttonViewProductSales.setBackground(Theme.BACKGROUND_BUTTON_PRIMARY);
		buttonViewProductSales.setForeground(Theme.COLOR_BUTTON_PRIMARY);
		buttonViewProductSales.addActionListener(this);
		panel.add(buttonViewProductSales);
                
            /* buttonViewProductStore = new JButton("GO TO WAREHOUSE");
		//buttonViewProduct.setBounds(60, 160, 200, 30);
		buttonViewProductStore.setFont(Theme.FONT_BUTTON);
		buttonViewProductStore.setBackground(Theme.BACKGROUND_BUTTON_PRIMARY);
		buttonViewProductStore.setForeground(Theme.COLOR_BUTTON_PRIMARY);
		buttonViewProductStore.addActionListener(this);
		panel.add(buttonViewProductStore);
*/
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonProfile)) {
			...
			new ViewProductActivity(this, employee).setVisible(true);
                ...
                else if (ae.getSource().equals(buttonViewProductSales)) {
			this.setVisible(false);
			new ViewSalesActivity(this, employee).setVisible(true);
                        //JOptionPane.showMessageDialog(null,"PURCHASE HISTORY","Alert",JOptionPane.INFORMATION_MESSAGE);
		}
